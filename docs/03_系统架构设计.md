...
- **[04_接口设计文档](04_接口设计文档.md)**：ROS2消息/服务/动作定义、Modbus协议规范、HTTP API、数据库接口
- **[05_详细设计文档](05_详细设计文档.md)**：硬件接口层、控制器配置、应用层节点、Launch文件的详细实现
...
> 详细的类设计、Modbus寄存器映射表见 **[05_详细设计文档 - 1.1节](05_详细设计文档.md#11-epoxysystemhardware-类设计)**
...
> 详细的控制器参数配置、Ackermann转向几何计算、轨迹插补算法见 **[05_详细设计文档 - 2节](05_详细设计文档.md#2-控制器配置详细设计)**
...
> 详细的QoS配置YAML见 **[05_详细设计文档 - 4.3节](05_详细设计文档.md#43-qos配置文件)**
...
> 详细的InfluxDB数据模型、Retention Policy配置见 **[04_接口设计文档 - 4.3节](04_接口设计文档.md#43-influxdb时序数据)**
...
> 详细的节点列表、依赖关系、systemd配置见 **[05_详细设计文档 - 6节](05_详细设计文档.md#6-部署配置)**
...
> 详细的安装命令、systemd服务文件配置见 **[05_详细设计文档 - 6.2.3节](05_详细设计文档.md)** (待创建)
...
> 详细的语音播报优先级表、告警规则配置见 **[05_详细设计文档 - 3.2节](05_详细设计文档.md#32-alert_node-语音播报节点)**
